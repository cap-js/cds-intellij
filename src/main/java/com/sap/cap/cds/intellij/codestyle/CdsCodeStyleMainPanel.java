...
import com.sap.cap.cds.intellij.CdsProjectCodeStyleSchemeService;
...
public class CdsCodeStyleMainPanel extends TabbedLanguageCodeStylePanel {
    ...
    protected CdsCodeStyleMainPanel(CodeStyleSettings currentSettings, @NotNull CodeStyleSettings settings) {
        ...
        for (Project project : ProjectManager.getInstance().getOpenProjects()) {
            project.getService(CdsProjectCodeStyleSchemeService.class);
        }
        getApplication().getService(CdsDefaultCodeStyleSchemeService.class);
    }
