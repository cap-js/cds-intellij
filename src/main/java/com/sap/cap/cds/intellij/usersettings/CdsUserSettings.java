...
public class CdsUserSettings {
    ...
    public static String getLabel(String settingKey) {
        return switch (settingKey) {
            ...
            case "cds.workspace.debounceFastChanges" -> "Debounce Fast Changes";
            case "cds.workspace.fastDiagnosticsMode" -> "Fast Diagnostics Mode";
    ...
    public static String getDescription(String settingKey) {
        return switch (settingKey) {
            ...
            case "cds.workspace.debounceFastChanges" -> "Consolidate workspace changes (e.g. by typing) to reduce the number of compilations, thus increasing performance. This is especially true for large models. Disable if you should see inconsistencies e.g. error markers not matching the corresponding identifier token";
    ...
    public static String[] getEnumValues(String settingKey) {
        return switch (settingKey) {
            ...
            case "cds.workspace.fastDiagnosticsMode" -> new String[]{"Clear", "Partial", "Full"};
