...
public class CdsUserSettings {
    ...
    public static String getCategory(String settingKey) {
        return switch (settingKey) {
            case "cds.compiler.markMissingI18nDefault" -> "Compiler";
            case "cds.compiler.showInternalErrors" -> "Compiler";
            ...
            case "cds.semanticHighlighting.odata.enabled" -> "Editor";
            case "cds.semanticHighlighting.enabled" -> "Editor";
            case "cds.quickfix.importArtifact" -> "Editor";
            case "cds.outline.semantical" -> "Outline";
            case "cds.outline.elements.associationComposition" -> "Outline";
            case "cds.refactoring.files.delete.enabled" -> "Refactoring";
            case "cds.refactoring.files.rename.enabled" -> "Refactoring";
            ...
            case "cds.typeGenerator.localInstallationOnly" -> "Type Generator";
            case "cds.typeGenerator.outputPath" -> "Type Generator";
            case "cds.workspace.persistency.garbageCollectOrphanedIndexesAfterNSaves" -> "Workspace";
            case "cds.workspace.persistency.garbageCollectOrphanedIndexesAfterStartup" -> "Workspace";
            case "cds.workspace.persistency.indexAllAfterStartup" -> "Workspace";
            case "cds.workspace.persistency.persistAfterCompile" -> "Workspace";
            case "cds.workspace.persistency.persistAfterSave" -> "Workspace";
            case "cds.workspace.persistency.enabled" -> "Workspace";
            case "cds.workspace.persistency.reindexAfterCompileIfRestored" -> "Workspace";
            case "cds.workspace.persistency.restoreAfterStartup" -> "Workspace";
            case "cds.workspace.persistency.restoreBeforeCompile" -> "Workspace";
            case "cds.workspace.scanCsn" -> "Workspace";
            case "cds.workspace.scanDependentModules" -> "Workspace";
